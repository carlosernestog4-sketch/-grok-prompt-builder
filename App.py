...
st.set_page_config(page_title="Grok Prompt Builder v20.0 Nuclear 2025", layout="centered")
...
st.markdown("<h1>Grok Prompt Builder v20.0 Nuclear Ultimate 2025</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: #aaa;'>Por Carlos Ernesto - Perfeccionador Totalmente Independiente</p>", unsafe_allow_html=True)
...
prompt_en_main = f"{texto_fijo_inicio}{base_nuclear_main} {nitidez_texto}{contraste_color_texto}{prioridad_final_main}{sujeto_final_main}{tipo_plano_main}, shot on {lente_main}, {iluminacion_main}, {composicion_main}, prioritise natural skin texture visible pores micro-details realistic imperfections subtle wrinkles fabric grain, {fondo_final_main}, {detalles_final_main}, ultra HD 8K photorealistic maximum clarity detail Adobe RGB vibrant rich colors, {firma_obligatoria}"

prompt_es_main = f"{texto_fijo_inicio}{base_nuclear_main} {nitidez_texto}{contraste_color_texto}{prioridad_final_main}Retrato fotorealista de {identidad_main}, {tipo_plano_main}, tomado con {lente_main}, {iluminacion_main}, {composicion_main}, priorizar textura piel natural poros visibles micro-detalles imperfecciones realistas arrugas sutiles grano tela, {fondo_final_main}, {detalles_final_main}, ultra HD 8K fotorealista maximo detalle claridad Adobe RGB colores ricos vibrantes, {firma_obligatoria}"
...
with col1:
    if st.button("Copiar Ingles (principal)"):
        ...
        st.success("Prompt Ingles (principal) cop
